...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| P2609-14 | 2026-09-12 | P0099_Gutaki_Body_S2P3_Blueprint-Supports.stl_0.030_2.800_2026_09_12_19_37.goo | Dragon Resin Durable Grey | 0.03mm | 2.8s | 27.0s | 5 |  |  |  | Gutaki Body at default size (Large creature), hollowed, supports from HeyGears Blueprint Studio. 1931 layers = 57.9mm. Screened: islands much improved (54, largest 2184px2) but 47 suction cups, the largest 3443mm3 starting at 23.55mm - against 2mm3 on the solid Scylla. Hollowing traded islands for suction; drainage looks inadequate; in progress |
