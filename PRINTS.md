...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| P2609-15 | 2026-09-12 | P0099_Gutaki_Body_S2P3_STL_0.stl_0.030_2.800_2026_09_12_19_58.goo | Dragon Resin Durable Grey | 0.03mm | 2.8s | 27.0s | 5 |  |  |  | Gutaki Body, default size, solid, Blueprint auto-orient and auto supports. 1931 layers = 57.9mm, ~1mm support elevation. Screened: 1 island over 1000px2 (1544px2 at 12.45mm) and largest cup 18.9mm3, both far better than the hollowed P2609-14. But 34 suction cups all start at layer 0, ~11.2mm3 each, 380mm3 total - the raft cells sealed by the low elevation; in progress |
...
| P0099_Gutaki_S2P3 | Gutaki | 50mm | Body | 32mm |  | sliced | P2609-15 | fail | warped during printing: ridges parallel to X along the rear of the integrated base, at approx rotX 20 - the peel signature of an X-tilted flat base. Reprint tilted about Y instead, with manual supports |
