...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| P2609-24 | 2026-09-16 | P0059_Horned_Dragon_Body_Rock_WP4_STL_2_202609160848_06h37m_49ml_uvtools-solidify.goo | Dragon Resin Durable Grey | 0.03mm | 2.8s | 27.0s | 5 |  |  |  | Horned Dragon Body and Rocks at standard scale, the 08:48 SatelLite slice put through UVtools Solidify to clear its resin traps, then sent to the printer by hand (Logan, 2026-09-16). Screened after solidifying: cups 6 -> 0, resin traps 2155 -> 199, islands 747 -> 725 with the reported island list identical line for line, so only interior voids were filled. One island remains over the threshold, 1132px2 at 74.49mm, about 68.5mm up the body - inspect that height when it comes off; two EVO-supported plates have printed clean through bigger. Motion values read 0.05 rather than 0 because UVtools re-saved the file, and the machine does execute them (runlog: lift_distance 0.050000 @ lift_speed 0.000833) - at no cost. PRINTING 2026-09-16, measured at layer ~1497 of 2653 (44.93mm): 8.45s per layer, steady, extrapolating to 6.2h against SatelLite's 06h37m estimate. So a UVtools re-save is safe to print on this machine. Screen flag inspected 2026-09-17: printed and cleaned successfully (Logan, 2026-09-17); the 1132px2 island at 74.49mm produced no reported defect |
...
| P0059_Horned_Dragon_WP4 | Horned Dragon | 50mm | Body | 32mm |  | cleaned | P2609-24 |  | reprinted 2026-09-01 at 1.5s from the 32mm heroic mesh; Brian reports the rocks and wings do not fit it. Whole set being reprinted with manual supports. Reprint from the STANDARD (true-scale) mesh, not the 32mm one (Logan, 2026-09-16): the whole set goes standard so the dragon is not larger than its 50mm base. On this model the 32mm meshes measure 1.150x the standard ones on all four parts, which is exactly the mismatch that stopped these fitting. Sliced 2026-09-16 on P0059_Horned_Dragon_Body_Rock_WP4_STL_2_202609160848.goo (in sweeps/, not yet on the printer): 2653 layers = 79.59mm, which is the 73.60mm standard body plus a ~6mm lift, confirming the standard family. SCREENED before printing, verdict FIX: one island of 1132px2 at 74.49mm, about 68.5mm up the body once the lift is subtracted, near its top. 747 islands in all; the next largest are 680px2 at 26.79mm and 648px2 at 67.38mm. Cups are unremarkable, the largest 6.3mm3 at 42.87mm, below the 15mm3 flag. SOLIDIFIED 2026-09-16 (Logan), UVtools Solidify with LayerIndexStart=300: cups 6 -> 0, resin traps 2155 -> 199, islands 747 -> 725 and the reported island list identical line for line, so the outer contours were untouched and only interior voids filled. NOTE on the motion values: UVtools' save rewrote LiftHeight, LiftSpeed and the Retract and Bottom equivalents from 0 to 0.05. MEASURED on P2609-24 and harmless: the machine does execute what the file carries - the runlog shows lift_distance 0.050000 at lift_speed 0.000833 - but it costs nothing. 8.45s per layer, steady over 20 layers, which extrapolates to 6.2h for 2653 layers against SatelLite's own 06h37m estimate. They cannot be changed anyway: RetractHeight is read-only, and the settable ones clamp straight back to 0.05 on save, per layer as well as globally. The 1000px2 threshold came from Lychee supports and has since been printed through twice on SatelLite EVO supports (P2609-16, P2609-20), so treat 74.49mm as a height to inspect rather than a predicted failure. NOT in the flagged queue: the slice has no plate yet, so no verdict.tsv was written |
| P0059_Horned_Dragon_WP4 | Horned Dragon | 50mm | Rocks | 32mm |  | cleaned | P2609-24 |  | does not fit the reprinted 32mm heroic body, so this was likely printed full size while the body was not. Reprint from the STANDARD (true-scale) mesh, not the 32mm one (Logan, 2026-09-16): the whole set goes standard so the dragon is not larger than its 50mm base. On this model the 32mm meshes measure 1.150x the standard ones on all four parts, which is exactly the mismatch that stopped these fitting. Sliced 2026-09-16 on P0059_Horned_Dragon_Body_Rock_WP4_STL_2_202609160848.goo (in sweeps/, not yet on the printer): 2653 layers = 79.59mm, which is the 73.60mm standard body plus a ~6mm lift, confirming the standard family. SCREENED before printing, verdict FIX: one island of 1132px2 at 74.49mm, about 68.5mm up the body once the lift is subtracted, near its top. 747 islands in all; the next largest are 680px2 at 26.79mm and 648px2 at 67.38mm. Cups are unremarkable, the largest 6.3mm3 at 42.87mm, below the 15mm3 flag. SOLIDIFIED 2026-09-16 (Logan), UVtools Solidify with LayerIndexStart=300: cups 6 -> 0, resin traps 2155 -> 199, islands 747 -> 725 and the reported island list identical line for line, so the outer contours were untouched and only interior voids filled. NOTE on the motion values: UVtools' save rewrote LiftHeight, LiftSpeed and the Retract and Bottom equivalents from 0 to 0.05. MEASURED on P2609-24 and harmless: the machine does execute what the file carries - the runlog shows lift_distance 0.050000 at lift_speed 0.000833 - but it costs nothing. 8.45s per layer, steady over 20 layers, which extrapolates to 6.2h for 2653 layers against SatelLite's own 06h37m estimate. They cannot be changed anyway: RetractHeight is read-only, and the settable ones clamp straight back to 0.05 on save, per layer as well as globally. The 1000px2 threshold came from Lychee supports and has since been printed through twice on SatelLite EVO supports (P2609-16, P2609-20), so treat 74.49mm as a height to inspect rather than a predicted failure. NOT in the flagged queue: the slice has no plate yet, so no verdict.tsv was written |
| P0059_Horned_Dragon_WP4 | Horned Dragon | 50mm | WingL | 32mm |  | reprint |  | fail | does not fit the reprinted 32mm heroic body; likely printed full size while the body was not. Reprint from the STANDARD (true-scale) mesh, not the 32mm one (Logan, 2026-09-16): the whole set goes standard so the dragon is not larger than its 50mm base. On this model the 32mm meshes measure 1.150x the standard ones on all four parts, which is exactly the mismatch that stopped these fitting. Sliced 2026-09-16 on P0059_Horned_Dragon_Wing_L_R_WP4_STL_1_202609160850.goo (in sweeps/, not yet on the printer): 3108 layers = 93.24mm against the 88.19mm standard WingL, confirming the standard family. SCREENED before printing, verdict FIX on BOTH counts. Suction cups are the serious one, measured over four detection runs: ONE dominant pocket of ~135mm3 spanning 42.51-58.6mm, footprint 23.6x23.2mm at plate X 85.7-109.3 Y 16.4-39.6, holding about 60% of the 223mm3 trapped above the raft on this plate. Runs B and D agree to 0.6% (136.0 and 135.2mm3, same start and footprint); the first run through `screen` split that one cavity into pieces and reported 115.5mm3 from 46.50mm, so treat the screen's per-cup list as indicative and its totals as solid. For scale, above the raft: everything that printed successfully here tops out at 102.4mm3 (P2609-16, largest cup 35.5mm3), and the P2609-15 failure had 48.2mm3. This plate was 2.2x the former and its single pocket 4x the largest cup ever recorded. SOLIDIFIED 2026-09-16 (Logan), UVtools Solidify: cups 23 -> 0 and all 223mm3 of trapped resin gone, resin traps 2280 -> 134, islands 510 -> 482 with the largest unchanged at 1033px2/68.67mm, so no drain holes and no reorientation were needed. NOTE on the motion values: UVtools' save rewrote LiftHeight, LiftSpeed and the Retract and Bottom equivalents from 0 to 0.05. MEASURED on P2609-24 and harmless: the machine does execute what the file carries - the runlog shows lift_distance 0.050000 at lift_speed 0.000833 - but it costs nothing. 8.45s per layer, steady over 20 layers, which extrapolates to 6.2h for 2653 layers against SatelLite's own 06h37m estimate. They cannot be changed anyway: RetractHeight is read-only, and the settable ones clamp straight back to 0.05 on save, per layer as well as globally. Note the classes overlap - P2609-16 printed fine with twice P2609-15's trapped volume - so this is "far outside anything on record", not a predicted failure. Also one island of 1033px2 at 68.67mm (about 62.7mm up the part) among 510, and 2280 resin traps. Islands have printed through twice on EVO supports, but no support recipe drains a trapped pocket: consider drain holes or a different orientation before running this. NOT in the flagged queue: the slice has no plate yet, so no verdict.tsv was written |
